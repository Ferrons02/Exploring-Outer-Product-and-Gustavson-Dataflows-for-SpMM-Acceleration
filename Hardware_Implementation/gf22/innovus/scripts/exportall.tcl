...
foreach cell [dbGet -p head.libCells.name *] {
  ...
  # process cell
  if [string match "TGPCI_*"       [dbGet ${cell}.name]]  { lappend excludeCellInstList  [dbGet ${cell}.name]}
...
streamOut out/${NAME}.gds.gz  -mapFile ../technology/22FDSOI_edi2gds_colored.layermap -outputMacros -merge {  \
  /usr/pack/gf-22-kgf/dz/../gf/pdk-22FDX-PLUS-V1.0_3.0a/ChipKit/MetrologyCells/PCI/GDSII/TGPCI_10M_2Mx_6Cx_2Ix_LB.gds \
  ...
  /usr/pack/gf-22-kgf/invecas/io/2020.01/IN22FDX_GPIO18_10M3S40PI_BE_RELV02R02SZ/gds/IN22FDX_GPIO18_10M3S40PI.gds \
 }
