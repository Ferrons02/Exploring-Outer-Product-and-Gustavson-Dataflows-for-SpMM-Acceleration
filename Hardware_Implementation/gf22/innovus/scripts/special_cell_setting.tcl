...
##########################################################################
# v1.1 - <zerun@ethz.ch> - Wed 14 Aug 15:48:35 CEST 2024
#  - put setEndCap back, not use bottom/top NOM1 endcap
...
set endCapList(top)    [dbGet [dbGet -p head.libCells.subclass coreEndCapTopEdge].name SC8T_COLCAP*]
set endCapList(bottom) [dbGet [dbGet -p head.libCells.subclass coreEndCapBottomEdge].name SC8T_COLCAP*]
